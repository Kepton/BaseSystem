    ...
    setValues: function (jq, values) {
        ...
        return jq.each(function () {
            ...
            for (var i = 0; i < vs.length; i++) {
                ...
                panel.find('div.combobox-item:contains(' + s + ')').addClass('combobox-item-selected');
            }
...
$.extend($.fn.combotree.methods, {
    setValues: function (jq, values) {
        ...
        return jq.each(function () {
            ...
            $(target).combo("setText", ss.join(options.separator)).combo("setValues", options.multiple ? vv : (vv.length ? vv : [""]));
        });
    }
});

...
tip.removeClass("tooltip-top tooltip-bottom tooltip-left tooltip-right").addClass("1tooltip-"+opts.position);
var left,top;
if(opts.trackMouse){
t=$();
...
$.fn.tabs.defaults={width:"auto",height:"auto",headerWidth:150,tabWidth:"auto",tabHeight:30,selected:0,showHeader:true,plain:false,fit:false,border:true,tools:null,toolPosition:"right",tabPosition:"top",scrollIncrement:100,scrollDuration:400,onLoad:function(_36e){
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"This field is required22222.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,events:{focus:_429,blur:_42d,mouseenter:_431,mouseleave:_434,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
...
_475.unbind().bind(
		...
		function(e) {
				var icon = $(e.target).closest(
						"input.textbox-text:not(.textbox-icon-disabled)");
				if (icon.length) {
					var _478 = parseInt(0);
					var conf = opts.icons[_478];
					if (conf && conf.handler) {
...
$(_6dd)._outerWidth(_6de)._outerHeight(26);
}
}};
};
};
...
$(_6f6)._outerWidth(_6f7)._outerHeight(26);
}}});
...
$.fn.combogrid.defaults=$.extend({},$.fn.combo.defaults,$.fn.datagrid.defaults,{height:26,loadMsg:null,idField:null,textField:null,mode:"local",keyHandler:{up:function(e){
nav(this,"prev");
e.preventDefault();
},down:function(e){
nav(this,"next");
...
_9c3(_9d6);
	...
	//-------添加清除按钮----
	text : function(clean) {
		return $(clean).datebox("options").cleanText;
	},
	handler : function(clean_h) { 
		$(clean_h).combo("setValue","").combo("setText","");
		$(clean_h).combo("hidePanel");
	}
},{text:function(_9d7){
